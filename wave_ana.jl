...
module Fourier_trans
    ...
    function EOF(arr :: Array{Float64, 2})
        # Declare section
        L, E :: Array{Float64, 2}
    ...
    function poly_itp(arr, ori_dim, new_dims)
        
        # Create the Vandermonde matrix
        V = Vandermonde(ori_dim)
        ...
        # Create the Vandermonde matrix for the new dimensions
        V_new = Vandermonde(new_dims)
        
        # Evaluate the polynomial at the new dimensions
        arr_new = V_new[:, 1:size(V_inv, 2)] * coe
